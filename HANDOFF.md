...
- **Fecha**: 2026-08-14
- **Qué se hizo** — **Ledger: comisión $/% + nota visible + obligatorios marcados HECHO** (feedback de testing del ledger; detalle en `DONE.md`):
