...
- **Quitar "Créditos"** — en resúmenes de tarjeta los créditos no aportan; eliminar la card "Créditos" y la lógica de créditos en `lib/analysis.js` + `Dashboard.js` (balanceTrend/expenseTrend solo débitos). _Nota: al quitar créditos, "Neto" queda = débitos en negativo; decidir en implementación si se conserva o elimina._
